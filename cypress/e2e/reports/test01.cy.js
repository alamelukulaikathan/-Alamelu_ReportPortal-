...
describe('Automation Test Suite - Fixtures', function () { 
    ...
    //cy.get('.headerCell__title-short--3_s1A').eq().should('have.text', this.data.header) 
    
    //cy.get(':nth-child(3) > .headerCell__title-container--Bt3as > .headerCell__title-short--3_s1A').should('have.text', this.data.total) 